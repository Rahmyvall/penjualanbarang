...
<head>
      ...
      <title>App Penjualan Barang - Login</title>
                                          ...
                                          <div class="col-lg-6">
                                                <div class="p-5">
                                                      <div class="text-center mb-4">
                                                            <h1 class="h4 text-gray-900">Aplikasi Penjualan Barang
                                                            </h1>
                                                            <span class="text-muted">Perlengkapan Penjualan Barang
                                                                  Aset</span>
                                                      </div>
                                                      <div class="row">
                                                            <div class="col-lg-12">
