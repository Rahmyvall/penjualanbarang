                                                      ...
                                                      <form action="<?= base_url('barang/proses_ubah/' . $barang->kode_barang) ?>"
                                                            ...
                                                            <div class="form-row">
                                                                  <div class="form-group col-md-6">
                                                                        <label for="kode_barang"><strong>Kode
                                                                                    Barang</strong></label>
                                                                  ...
                                                                  <div class="form-group col-md-6">
                                                                        <label for="nama_barang"><strong>Nama
                                                                                    Barang</strong></label>
                                                            ...
                                                            <div class="form-row">
                                                                  <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="number" name="stok"
                                                                              ...
                                                                              autocomplete="off" class="form-control"
                                                                              required value="<?= $barang->stok ?>">
                                                                  </div>
                                                                  <div class="form-group col-md-6">
                                                                        <label
                                                                              for="satuan"><strong>Satuan</strong></label>
                                                                        <select name="satuan" id="satuan"
                                                                              ...
                                                                              <option value="unit"
                                                                                    ...
                                                                                    UNIT</option>
                                                                              <option value="pac"
                                                                                    <?= $barang->satuan == 'pac' ? 'selected' : '' ?>>
                                                                                    PAC</option>
                                                                              <option value="dus"
                                                                                    <?= $barang->satuan == 'dus' ? 'selected' : '' ?>>
                                                                                    DUS</option>
                                                                        </select>
                                                                  </div>
                                                            </div>
                                                            <div class="form-row">
                                                                  <div class="form-group col-md-6">
                                                                        <label for="jumlah_terjual"><strong>Jumlah
                                                                                    Terjual</strong></label>
                                                                        <input type="number" name="jumlah_terjual"
                                                                              placeholder="Masukkan jumlah_terjual"
                                                                              autocomplete="off" class="form-control"
                                                                              required
                                                                              value="<?= $barang->jumlah_terjual ?>">
                                                                  </div>
                                                                  <div class="form-group col-md-6">
                                                                        <label
                                                                              for="satuan"><strong>Satuan</strong></label>
                                                            ...
                                                            <div class="form-row">
                                                                  <div class="form-group col-md-6">
                                                                        <label for="jenis_barang"><strong>Jenis
                                                                                    Barang</strong></label>
